...
const swaggerDefinition = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "This is an user aunthenticated football api where once the user registers and logins with the same  credentials , user would get a access token which ca help user to access the football api routes.",
    license: {
